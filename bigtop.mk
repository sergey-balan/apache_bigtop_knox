...
#KNOX_TARBALL_DST=$(KNOX_NAME)-$(KNOX_BASE_VERSION)-SNAPSHOT.tar.gz
#KNOX_TARBALL_SRC=${KNOX_TARBALL_DST}
KNOX_TARBALL_SRC=$(KNOX_NAME)-$(KNOX_BASE_VERSION)-SNAPSHOT.tar.gz
KNOX_TARBALL_DST=$(KNOX_NAME)-$(KNOX_BASE_VERSION).tar.gz
KNOX_DOWNLOAD_PATH=/job/Knox-master-daily/ws/target/$(KNOX_PKG_VERSION)-SNAPSHOT
