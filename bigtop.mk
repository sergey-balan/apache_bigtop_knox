...
# Knox
KNOX_NAME=knox
KNOX_RELNOTES_NAME=Apache Knox
KNOX_PKG_NAME=knox
KNOX_BASE_VERSION=0.3.0
KNOX_PKG_VERSION=$(KNOX_BASE_VERSION)
KNOX_RELEASE_VERSION=1
KNOX_NAME_SUFFFIX=-SNAPSHOT #IMPORTANT: If it will be changed then you should make corresponding changes in the %prep section of the knox.spec file
KNOX_TARBALL_SRC=$(KNOX_NAME)-$(KNOX_BASE_VERSION)$(KNOX_NAME_SUFFFIX).tar.gz
KNOX_TARBALL_DST=$(KNOX_NAME)-$(KNOX_BASE_VERSION).tar.gz
KNOX_DOWNLOAD_PATH=/job/Knox-master-daily/ws/target/$(KNOX_PKG_VERSION)$(KNOX_NAME_SUFFFIX)
KNOX_SITE=$(APACHE_BUILDS)$(KNOX_DOWNLOAD_PATH)
KNOX_ARCHIVE=$(APACHE_BUILDS)$(KNOX_DOWNLOAD_PATH)
$(eval $(call PACKAGE,knox,KNOX))
